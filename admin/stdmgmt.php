    ...
    <table border="1">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td><a href='verify/verifystd.php?id=" . $row["id"] . "' style='text-decoration: none; color: black; display: inline-block; width: 100%;'><button style='width: 100%;'>Verify</button></a>";
                // echo "<td><button style='width:100%'><a href='verify/verifystd.php?id=" . $row["id"] . "'style='text-decoration: none;color:black;'>Verify</a></button>";
                // echo "<br><button style='width:100%'><a href='verify/deletestd.php?id=" . $row["id"] . "' style='text-decoration: none;color:black;'>Delete</a></button>";
                echo "<br><a href='verify/deletestd.php?id=" . $row["id"] . "' style='text-decoration: none; color: black; display: inline-block; width: 100%;'><button style='width: 100%;'>Delete</button></a></td>";
